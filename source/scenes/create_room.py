...
class CreateMenuScene(Scene):
    """
    The create room scene.
    """

    def __init__(self, controller):
        """
        Create a new create room scene.
        """
        super().__init__("create_room_scene", controller, debug=controller.debug)
    ...
    def on_enter(self):
        ...
        settings = self.controller.localizations.get_key("create_room", lang)
